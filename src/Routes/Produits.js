...
function Produits() {
  ...
  const handlepagination = (e) => {
    ...
    navigate("/products?page=" + e.target.value);
  };

  return (
    <div>
      "Pagination new new new new new "
        ...
        return (
          <>
            <div key={index}>
              ...
              {"Price: " + produit.price}
              <br />
              <a href={"/products/" + produit._id}>
                {" "}
                <img height={120} width={120} src={produit.imageUrl} />{" "}
              </a>
              <br />
              {"review avg: " +
                produit.reviews?.reduce(
